...
function changeAvatar() {
  ...
  if (letter) {
    ...
    const avatar = document.getElementById('accAvatar') || letter.parentElement;
    if (avatar) avatar.style.background = `linear-gradient(135deg, ${colors[idx]}, ${colors[(idx+1)%colors.length]})`;
  }
}
