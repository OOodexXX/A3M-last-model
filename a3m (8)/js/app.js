...
function applyLang(lang) {
  ...
  ['c-all','c-tshirt','c-hoodie','c-bag','c-laser','c-paper'].forEach((id, i) => {
    const val = [t.cAll,t.cTshirt,t.cHoodie||'🧥 Hoodies',t.cBag,t.cLaser,t.cPaper][i];
    safe(id, val);
  });
...
document.addEventListener("DOMContentLoaded", () => {
  loadTheme();
  const savedLang = localStorage.getItem("a3m_lang") || "en";
